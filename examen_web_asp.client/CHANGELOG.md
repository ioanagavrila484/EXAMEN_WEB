...
- Create Angular project with ng: `ng new examen_web_asp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`examen_web_asp.client.esproj`).
